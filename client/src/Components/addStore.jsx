        ...
        <div className='bg-opacity-90 justify-center bg-black rounded-xl mt-8 mb-4 pr-6 pl-6 '>
          ...
          <div className='flex justify-center items-center'>
                ...
                <input
                  ...
                  className='w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-cbb26a mb-4 mt-1 mb-1'
                  required
                />
                ...
                <button
                  type='submit'
                  className='flex justify-center mx-auto sm:px-4 md:px-6 lg:px-8 text-xl font-bold text-cbb26a bg-black font-bold text-cbb26a text-center imageBorderLogo py-2 px-4 rounded-md transition duration-300 hover:text-white mt-6 mb-8'
                >
                  Add Store
                </button>
