    ...
    <PolicyBackground>
      <div className='containerText flex flex-1 ml-6 mr-6 pt-8 pb-4'>
        <p className='container text-cbb26a mx-auto p-4 lg:w-2/3 xl:w-1/2 bg-black opacity-80 rounded-md pt-8 pb-8'>
          ...
          <p>
            <br />
            We would like to emphasize the importance of providing a fair
            review for our BurgerStore. Our community and future customers
            rely on your honest opinions to make informed decisions about
            their visit.
          </p>
          <br />
          <p>
            Fair reviews not only assist others in selecting the right
            BurgerStore but also help us continuously improve our service
            and products. Your feedback is invaluable and enables us to
            respond to your needs, creating a better shopping experience.
          </p>
          <br />{' '}
          <p>
            Please take a moment to share your experiences fairly and
            objectively. Include both positive and constructive criticism.
            Your contribution helps build an open and transparent community.
          </p>
          <br />
