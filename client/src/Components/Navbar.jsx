    ...
    <div className='container flex h-24 bg-gradient-to-r from-black via-gray-800 to-gray-900  p-4 text-base  text-cbb26a relative z-50'>
      ...
      <div className='flex-1 flex flex-row' >
        <div className="flex flex-col items-center md:flex-row">
          <Link to='/' className='cursor-pointer hover:opacity-80 sm:p-4 '>Home</Link>
          <Link to='/burgerstores' className='cursor-pointer hover:opacity-80 sm:p-4 '>Stores</Link>
        </div>

        <div className='flex relative z-1 '> <Search /></div>
      </div>
