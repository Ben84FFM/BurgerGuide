...
const Footer = () => {
  ...
  return (
    <footer className="container flex bg-black text-cbb26a py-8 border-t border-gray-500">
      <div className="container mx-auto flex flex-wrap justify-center lg:justify-between ml-4">
        ...
        <div className="footer-section mt-4 lg:mt-0 mb-4 lg:mb-0 w-full lg:w-1/4">
          ...
          <div className="flex items-center space-x-4">
            <a href="https://www.linkedin.com/dein-linkedin" target="_blank" rel="noopener noreferrer" className="text-cbb26a hover:text-white">
              <FontAwesomeIcon icon={faLinkedin} size="2x" />
            </a>
            <a href="https://www.instagram.com/dein-instagram" target="_blank" rel="noopener noreferrer" className="text-cbb26a hover:text-white">
              <FontAwesomeIcon icon={faInstagram} size="2x" />
            </a>
            <a href="https://www.facebook.com/dein-facebook" target="_blank" rel="noopener noreferrer" className="text-cbb26a hover:text-white">
